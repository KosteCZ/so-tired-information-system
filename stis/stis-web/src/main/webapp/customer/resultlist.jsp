...
<s:layout-render name="/layout.jsp" title="${title}">
    <s:layout-component name="content">   
        <s:link class="btn" beanclass="cz.muni.fi.pa165.stis.web.CustomerActionBean" style="margin-bottom: 5px;" event="list"><i class="icon-arrow-left"></i> <f:message key="button.back"/></s:link>        
        ...
        <s:layout-render name="/extraservice/tableLayout.jsp" items="${actionBean.foundList}"/>
        </c:when>
        <c:otherwise>
